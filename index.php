...
require_once (dirname(__FILE__) . '/protected/components/Facebook-sdk3/src/facebook.php');
require_once (dirname(__FILE__) . '/protected/components/Facebook-sdk3/src/base_facebook.php');
