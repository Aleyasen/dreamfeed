...
abstract class BasePostData extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('id, friend, post_id, seen, from_id, from_name, story, link, picture, source, name, description, message, user, created_time, chosen, changed, type', 'safe', 'on'=>'search'),
		);
	}
